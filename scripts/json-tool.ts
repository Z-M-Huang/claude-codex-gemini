#!/usr/bin/env bun
/**
 * Cross-platform JSON tool for pipeline state management.
 * Works on Windows, macOS, and Linux via Bun.
 *
 * Usage:
 *   bun json-tool.ts get <file> <path>           - Get value at JSON path
 *   bun json-tool.ts set <file> <updates...>     - Update values
