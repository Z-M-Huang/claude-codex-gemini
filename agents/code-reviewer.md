...
**Use the Write tool** to write the review output. The Gemini orchestrator specifies the output file path via the --output parameter when invoking this agent (e.g., .task/code-review-sonnet.json or .task/code-review-opus.json).
